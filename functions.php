...
function unggah($nama, $nim, $kelompok, $kata_sandi) {
	...
	// } else {
		$query = "INSERT INTO praktikan (nim, nama, kata_sandi, kelompok)
				 VALUES
				 ('$nim', '$nama', '$kata_sandi', '$kelompok')
				 ";
...
function dropinfo($nim) { // membuat function yang namanya hapus yang menerima id, id dikirimkan dari halaman hapus kemudian masuk ke sini
	global $conn;
	mysqli_query($conn, "UPDATE praktikan SET asisten = '' WHERE nim='$nim'");
