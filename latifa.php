...
include 'config.php';
$pengguna = query("SELECT * FROM praktikan where asisten = 'latifa' ");
$query = "SELECT * FROM praktikan where asisten = 'latifa' ";
  ...
  .mini {
    ...
    <body class="mt-5">
             ...
             <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
                    <div class="container">
                    <a class="navbar-brand" href="latifa.php">RESPON AKHIR SBD (<?=$nim?>)</a>
...
<div class="jumbotron jumbotron-fluid">
    <div class="container">
                  <div class="row">
                    <div class='com-ms'>
                        <h1 class="display-4">NUR IZZA LATIFAH</h1>
                        <?php
                          if($nim!='F1D018050'&&$count<4){
                            echo "<a href='ok.php?nim=".$nim."&hal=latifa'><img class='mini' src='img/complete1.png' style='max-height: 100px; max-width: 75px' ></a>";
                          }
                      ?>
        ...
        <div class="d-flex bd-highlight">
          <div class='p-2 bd-highlight'>
            <?php
              ...
              if($nim == $row['nim']){
                echo "<a href='sunting.php?nim=".$row['nim']."&hal=latifa'><img class='mini' src='img/pencil1.png'></a>";
              } else {
          ...
          <div class='p-2 bd-highlight'>
          <?php
              if($nim=='F1D018050'||$nim==$row['nim']){
                echo "<a href='dropinfo.php?nim=".$row['nim']."&hal=latifa'><img class='mini' src='img/trash2.png'></a>";
              } else {
                echo "<img class='mini' src='img/cancel1.png'>";
              }
          ?>
